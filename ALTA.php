...
<?php
$usuario= $_POST["usu"];
#Sanatización de parámetros para evitar las inyecciones SQL: quitan caracteres especiales como la
#comilla simple, etc (SOLO FUNCIONAN HASTA PHP 5!).
